...
from emmental.metrics.tp import tp_scorer
from emmental.metrics.fp import fp_scorer
from emmental.metrics.tn import tn_scorer
from emmental.metrics.fn import fn_scorer
from emmental.metrics.stroke_recall import stroke_recall_scorer
from emmental.metrics.hem_recall import hem_recall_scorer
from emmental.metrics.frac_recall import frac_recall_scorer
...
METRICS = {
    ...
    "fn":fn_scorer,
    "fp":fp_scorer,
    "stroke_recall":stroke_recall_scorer,
    "hem_recall":hem_recall_scorer,
    "frac_recall":frac_recall_scorer,
}
